namespace Sen.Script.Executor.Methods.PopCap.Newton.Encode {
    ...
    export function forward(): void {
        ...
        >({
            ...
            configuration_file: Sen.Script.Home.query("~/Executor/Configuration/popcap.newton.encode.json"),
            direct_forward(argument: Sen.Script.Executor.Methods.PopCap.Newton.Encode.Argument): void {
                Sen.Script.Console.obtained(argument.source);
                defined_or_default<Sen.Script.Executor.Methods.PopCap.Newton.Encode.Argument, string>(argument, "destination", `${Sen.Kernel.Path.except_extension(argument.source)}.newton`);
            ...
            batch_forward(argument: Sen.Script.Executor.Methods.PopCap.Newton.Encode.BatchArgument): void {
            ...
            async_forward(argument: Sen.Script.Executor.Methods.PopCap.Newton.Encode.AsyncArgument): void {
                Sen.Script.Executor.clock.start_safe();
